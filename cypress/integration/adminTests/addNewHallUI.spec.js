...
const {login, password, startPageForAdmin} = require("../../../cypress/fixtures/login_data.json");
const dataForHallCreation = require("../../../cypress/fixtures/dataForHallCreation.json"); 
